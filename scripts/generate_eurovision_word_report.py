...
def generate_report():
    ...
    title = doc.add_heading(
        "Informe de Inteligencia Estratégica: Eurovision Services", 0
    )
    ...
    ceo_summary = (
        data.get("business_context", {}).get("ceo_agenda", {}).get("summary", "N/A")
    )
    ...
    doc.add_paragraph("\n")
    doc.add_paragraph(
        "Este informe ha sido generado automáticamente por el Motor de Inteligencia Soberana V34.0 (NTT DATA)."
    )
