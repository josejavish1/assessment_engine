...
try:
    print(
        f"Probando conexión básica con gemini-1.0-pro en {os.environ['GOOGLE_CLOUD_PROJECT']}..."
    )
    ...
    print(
        f"❌ FALLO también con el modelo básico. El problema es el Proyecto/Facturación/API:\n{e}"
    )
