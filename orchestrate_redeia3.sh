...
# Modificar el client_intelligence.json para forzar el nombre del cliente a redeia3 para evitar colisiones y asegurar trazabilidad
PYTHONPATH=src $PYTHON_BIN -m application.tools.sign_dossier "${WORKING_DIR}/client_intelligence.json" "REDEIA3"
...
echo "==========================================================="
echo "✅ PROCESO FINALIZADO CON ÉXITO (REDEIA3 - ELITE MODE)"
