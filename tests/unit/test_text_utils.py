...
def test_clean_text_tier1() -> None:
    ...
    assert clean_text_for_word("Line with\x00 null and control \x1f") == "Line with null and control"
...
def test_normalize_tower_name() -> None:
    ...
    assert normalize_tower_name("Infraestructura de Red evalúa controles") == "Infraestructura de Red"
    assert normalize_tower_name("CPD de respaldo mide resiliencia:") == "CPD de respaldo"
