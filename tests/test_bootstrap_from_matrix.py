...
def test_bootstrap_logic_with_mocked_docx_read(
    mocker, mock_paragraphs, expected_definition, mock_base_definition
):
    """
    ...
    with tempfile.TemporaryDirectory() as temp_dir_str:
        ...
        tower_def, manifest, warnings = bootstrap_tower_from_matrix.bootstrap_tower(
            tower_id="T99", matrix_file=MagicMock(), out_dir=temp_out_dir
        )
