...
def _get_current_weather(location: str) -> dict:
    """Placeholder for a tool that gets the current weather."""
    logger.info(f"Tool call: get_current_weather(location='{location}')")
    ...
    try:
        ...
        if function_calls:
            ...
            for fc in function_calls:
                ...
                if tool_name in _function_dispatcher:
                    tool_func = _function_dispatcher[tool_name]
