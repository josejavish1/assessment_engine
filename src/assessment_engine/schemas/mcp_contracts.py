...
class StartJobResponse(BaseModel):
    """
    Defines the contract for the response of a tool that starts an async job.
    """
...
class CheckJobStatusResponse(BaseModel):
    """
    Defines the contract for the response of a tool that checks an async job's status.
    """
