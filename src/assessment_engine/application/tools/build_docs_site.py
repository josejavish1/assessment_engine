...
def build_site(repo_root: Path, documentation_map_path: Path, output_dir: Path) -> None:
    ...
    include_patterns = coverage.get("include", governance.DEFAULT_COVERAGE_INCLUDE)
    exclude_patterns = coverage.get("exclude", governance.DEFAULT_COVERAGE_EXCLUDE)
