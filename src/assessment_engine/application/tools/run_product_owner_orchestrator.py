...
from assessment_engine.application.tools.context_tools import get_context_tools
from assessment_engine.domain.prompts.product_owner_prompts import (
...
from assessment_engine.infrastructure.doctor_agent import DoctorAgent
from assessment_engine.infrastructure.liability_signer import LiabilitySigner
from assessment_engine.infrastructure.logger_config import setup_structured_logging
from assessment_engine.infrastructure.pipeline_runtime import (
    build_runtime_env,
)
from assessment_engine.infrastructure.product_owner_models import (
    ProductOwnerAlternatives,
)
from assessment_engine.infrastructure.runtime_paths import ROOT
from assessment_engine.infrastructure.secrets_client import get_secret
from assessment_engine.infrastructure.text_utils import slugify
from assessment_engine.infrastructure.verification_agent import (
    VerificationAgent,
)
...
def execute_plan(
    ...
    *,
    ...
    import assessment_engine.infrastructure.runtime_paths as rp
...
def main(argv: list[str] | None = None) -> int:
    ...
    if detect_prompt_injection(request_text):
        logger.error(
            "❌ [SECURITY ALERT] Prompt injection detected and blocked deterministically."
        )
