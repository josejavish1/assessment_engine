...
def main() -> None:
    ...
    try:
        ...
        if processed > 0:
            ...
            if triggered:
                logger.info("✓ Raptor RAG Knowledge Tree successfully rebuilt and synchronized.")
        else:
            logger.info("🟢 No pending evidence items in the queue. Everything is up to date!")
