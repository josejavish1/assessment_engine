...
COLOR_BLUE = "0072BC" # Provides a fallback value if the primary data retrieval operation fails.
...
def autofit_table_to_contents(table):
    ...
    tblW.set(qn('w:w'), '5000') # The OOXML table width unit is 1/50th of a percent. 5000 corresponds to 100%.
    tblPr.append(tblW)
